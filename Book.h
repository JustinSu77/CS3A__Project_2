...
public:
	...
	**/
	...
	/**
		...
		Result: - Private member variable code is set to given code
				...
				- Private member variable available is set
				  to given available
	...
	**/
	...
	/**
		...
		Precondition: Book object is instantiated
		Result: Set private member variable available
				to given available
	**/
	...
	**/
	...
	/**
		...
		Precondition: Book object is instantiated
		Result: Values of private member variables title,
				unique private member variable, available,
				and rented of polymorphic Book objects are
				outputted to terminal neatly formatted
	**/
	virtual void displaySearchedInfo() const = 0;

	/**
		Purpose: Return book code to allow templated function
				 that inserts templated nodes into Linked List
   ...
   **/
	...
	**/
	...
	/**
		...
		Precondition: Book object is instantiated
		Result: Values of private member variable code,
				formatted title, unique private member variable,
				available, and rented are neatly formatted to terminal
	**/
...
private:
	...
	// title of book
	std::string title;
	// Count for number of instance of 
	// this class to be rented
	int available;
	// Count for number of instance of 
	// this class rented
	int rented;
